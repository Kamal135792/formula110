"""Probe the remaining per-sector speed boundary around V44."""
...
SECTOR_CANDIDATES = (
    (1.12, 1.14, 1.16, 1.18, 1.24, 1.28, 1.32),
    (0.40, 0.48, 0.54, 0.58, 0.62, 0.66, 0.70),
    (0.40, 0.48, 0.54, 0.58, 0.62, 0.66, 0.70),
    (0.40, 0.48, 0.54, 0.58, 0.62, 0.66, 0.70),
    (0.70, 0.74, 0.78, 0.80, 0.82, 0.84, 0.88),
)


def main() -> int:
    gains = list(FINE_CURVE_SPEED_GAINS)
