"""V30: spawn-aware selection between V24 stability and V29 apex speed."""
...
from controllers.v29 import Controller as ApexController
from racing import RobotCommand, RobotSensors

RACING_NAME = "V30 Adaptive Apex Racer"
RACING_COLOR = "#00e5ff"
...
class Controller:
    ...
    def __call__(self, sensors: RobotSensors) -> RobotCommand:
        if sensors.tick == 0:
            ...
            straight_hazard = isfinite(front) and abs(far_offset) < 0.6 and (37.0 < front < 40.5 or 46.0 < front < 49.5)
