"""V9: high-speed planner with a residual policy retrained for it."""
...
RACING_NAME = "V9 Sprint Racer"
RACING_COLOR = "#ef4444"
_CONFIG_PATH = Path(__file__).with_name("v9_config.json")
_WEIGHTS_PATH = Path(__file__).with_name("v9_weights.json")
