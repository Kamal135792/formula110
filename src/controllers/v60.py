"""V60: V59 with the first-hairpin spawn partition routed to staged launch."""
...
RACING_NAME = "V60 Hairpin-Audited Spawn Racer"
RACING_COLOR = "#a855f7"
...
class Controller:
    def __init__(self, *, extended_curve_min_heading: float = 40.0) -> None:
        self._extended_curve_min_heading = extended_curve_min_heading
    ...
    def __call__(self, sensors: RobotSensors) -> RobotCommand:
        if sensors.tick == 0:
            ...
            extended_curve = self._extended_curve_min_heading < heading < 90.0 and far_offset < -7.0
    ...
    def copy_for_car(self) -> Controller:
        return Controller(extended_curve_min_heading=self._extended_curve_min_heading)
