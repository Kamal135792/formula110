"""V39: partition fallback plus one-second launch and aggressive apex line."""
...
RACING_NAME = "V39 Partition-Combined Racer"
RACING_COLOR = "#00ffaa"
...
class Controller:
    ...
    def __call__(self, sensors: RobotSensors) -> RobotCommand:
        ...
        return stable if self._use_stable else launch_apex
